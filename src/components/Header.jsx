            ...
            <div className="container">
                ...
                <div className="flex-center-between">
                    ...
                    <div className="flex-center gap-8 max-1140:gap-8 max-650:gap-6">
                        ...
                        {/* favorites link */}
                        <Link aria-label='favorites' to='/favorites' className='relative btn-normal text-white hover:text-primary-green'>
                            ...
                            {/* count */}
                            <span className="flex-center justify-center absolute w-5 h-5 rounded-full text-white bg-primary-green -top-1 -right-3 text-xs leading-none font-bold">0</span>
                        </Link>

                        {/* dev btn */}
                        <Link aria-label='developer' to='/developer' title='developer' className="btn-default flex-center gap-2 max-1140:p-3 max-950:p-0 max-950:bg-transparent text-primary-green max-950:text-white max-950:hover:text-primary-green">
