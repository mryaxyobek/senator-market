...
const MainRoot = () => {
    ...
    return (
        <div className='flex flex-col min-h-screen'>
            ...
            {/* contact btn */}
            <Link title='contact' aria-label='contact' to='/contact' className={`${scrollToTopBtnValue ? '-translate-y-14 scale-75 opacity-70' : 'translate-y-0'} btn-white`}>
            ...
            <button
                ...
                className={`${scrollToTopBtnValue ? 'translate-y-0' : 'translate-y-40'} btn-white bg-primary-green text-white`}
                onClick={() => {
                    window.scrollTo(0, 0);
                }}
            >
